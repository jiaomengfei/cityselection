...
import com.example.jiao.cityapplication.chatview.adapter.EmojiconGridAdapter;
import com.example.jiao.cityapplication.chatview.adapter.EmojiconPagerAdapter;
...
public class EmojiconPagerView extends ViewPager {
    ...
    public List<View> getGroupGridViews(EmojiconGroupEntity groupEntity){
        ...
        for(int i = 0; i < pageSize; i++){
            View view = View.inflate(context, R.layout.chat_expression_gridview, null);
          ...
          //jmf  if(emojiType != EaseEmojicon.Type.BIG_EXPRESSION){
