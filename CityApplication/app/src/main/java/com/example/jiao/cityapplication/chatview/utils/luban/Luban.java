package com.example.jiao.cityapplication.chatview.utils.luban;
...
public class Luban {
    ...
    public Luban launch() {
        ...
        if (mFile.getAbsolutePath().contains("gif")) {
            if (compressListener != null){}
        ...
        switch (gear) {
            case FIRST_GEAR:
                File firstCompress = firstCompress(mFile);
                if (firstCompress == null) {
                    if (compressListener != null)
                        compressListener.onError(new NullPointerException());
                } else {
                    if (compressListener != null)
                        compressListener.onSuccess(firstCompress);
                }
                break;
            case THIRD_GEAR:
                File thirdCompress = thirdCompress(mFile);
                if (thirdCompress == null) {
                    ...
                    if (compressListener != null)
                        compressListener.onSuccess(thirdCompress);
                }
                break;
        }
        return this;
